...
import xb.posservice.dao.HIS_SALE_DETAILMapper;
...
@Service("HisSaleDetailServiceImpl")
public class HisSaleDetailServiceImpl implements HisSaleDetailService{
	@Autowired
	HIS_SALE_DETAILMapper myMapper;
	public HIS_SALE_DETAIL selectByPrimaryKey(HIS_SALE_DETAILKey key) {
		// TODO Auto-generated method stub
		return myMapper.selectByPrimaryKey(key);
	}

	public List<HIS_SALE_DETAIL> selectByskt(SALE_DETAILKey key) {
		// TODO Auto-generated method stub
